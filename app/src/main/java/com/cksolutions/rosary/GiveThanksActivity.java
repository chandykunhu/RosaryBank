...
public class GiveThanksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_give_thanks);
        ...
        authListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null) {
                    ...
                    startActivity(new Intent(GiveThanksActivity.this, LoginActivity.class));
                    finish();
                }
            }
        };
        ...
        if (!uid.isEmpty() && uid.trim().length() > 0) {
            ...
            btnGiveThanks = (Button) findViewById(R.id.btSendThanks);
            btnGiveThanks.setEnabled(true);
            ...
            btnGiveThanks.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (Isconnected()) {
                        ...
                        final String thanks = inputPrayer.getText().toString().trim();
                    ...
                    /*while (!objPrayerHandler.IsPostExecute) {
                        ...
                        databaseRef2 = database.getReference("TransactionHistory").child(uid).child("ThanksGiven");
                        ...
                        btnGiveThanks.setEnabled(false);
                        //progress bar

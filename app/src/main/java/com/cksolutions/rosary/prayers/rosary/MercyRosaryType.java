...
public class MercyRosaryType extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mercy_rosary_type);
            ...
            public void onClick(View view, int position) {
                ...
                switch(album.getName())
                {
                    case "Mercy Rosary":
                        ...
                        //startActivity(new Intent(NormalRosaryType.this, NormalRosaryType.class));
                        break;
                    case "കാരുണ്യ ജപമാല" :
                        Toast.makeText(getApplicationContext(), "Under Construction",Toast.LENGTH_LONG).show();
                        //startActivity(new Intent(NormalRosaryType.this, MercyRosaryType.class));
                        break;
               }
            }
        ...
        try {
            Glide.with(this).load(R.drawable.mercyrosarycover).into((ImageView) findViewById(R.id.backdrop));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbar.setTitle("Mercy Rosary");
                    isShow = true;
                } else if (isShow) {
                    collapsingToolbar.setTitle(" ");
                    isShow = false;
    ...
    private void preparePrayerAlbums() {
        int[] covers = new int[]{
                R.drawable.englishmercyrosary,
                R.drawable.malayalammercyrosary};

        PrayerAlbum a = new PrayerAlbum("Mercy Rosary", 4, covers[0]);
        albumList.add(a);

        a = new PrayerAlbum("കാരുണ്യ ജപമാല", 4, covers[1]);
        albumList.add(a);
